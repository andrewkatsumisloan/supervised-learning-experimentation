...
def plot_hyperparameter_validation(lr_values, train_error_rates, test_error_rates):
    plt.figure(figsize=(12, 6))
    plt.plot(lr_values, train_error_rates, label="Training Error Rate")
    plt.plot(lr_values, test_error_rates, label="Test Error Rate")
    plt.xlabel("Learning Rate")
    plt.ylabel("Error Rate")
    plt.xscale("log")
    plt.title("Error Rate vs Learning Rate")
    plt.legend()
    plt.savefig("lr_validation_diabetes")
...
def main():
    ...
    for lr in lr_values:
        ...
        accuracy, class_report, model, train_error, test_error = (
    ...
    plot_error_rates(train_error, test_error, num_epochs, filename)
    plot_hyperparameter_validation(lr_values, train_error_rates, test_error_rates)
